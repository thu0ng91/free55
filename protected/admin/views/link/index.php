...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('link/create',array('menupanel'=>'content|link|link_create'));?>'">添加链接</button>
...
<?php 
    ...
    'columns'=>array(
    	...
    	array(
    		...
    		'updateButtonUrl'=>'Yii::app()->createUrl("link/update",array("id"=>"$data->id","menupanel"=>"$_GET[menupanel]"))',
    	),
    ),
));
 ?>
