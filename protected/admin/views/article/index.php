...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('article/create',array('menupanel'=>'content|article|article_create','cid'=>$_GET['cid']));?>'">添加文章</button>
...
<?php 
    ...
    'columns'=>array(
    	...
    	array(
    		...
    		'updateButtonUrl'=>'Yii::app()->createUrl("article/update",array("id"=>"$data->id","menupanel"=>"$_GET[menupanel]","cid"=>"$_GET[cid]","title"=>"$_GET[title]"))',
    	),
    ),
));
 ?>
