...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('live/create',array('menupanel'=>'content|live|live_create'));?>'">新增直播</button>
...
//    	),
    	array(
    		...
    		'updateButtonUrl'=>'Yii::app()->createUrl("live/update",array("id"=>"$data->id","menupanel"=>"$_GET[menupanel]"))',
    	),
    ),
));
 ?>
