...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('picture/create',array('menupanel'=>'content|picture|picture_create'));?>'">添加图片广告</button>
...
<?php 
    ...
    'columns'=>array(
    	...
    	array(
    		...
    		'updateButtonUrl'=>'Yii::app()->createUrl("picture/update",array("id"=>"$data->id","menupanel"=>"$_GET[menupanel]"))',
    	),
    ),
));
 ?>
