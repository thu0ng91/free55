    ...
    public function run()
    {
        ...
        foreach ($this->gallery->galleryPhotos as $photo) {
            $photos[] = array(
                ...
                'preview' => $photo->type > 0 ? $photo->file_name : $photo->getPreview(),
            );
        }
        ...
        $opts = array(
            ...
            'addNetworkPictureUrl' => Yii::app()->createUrl($this->controllerRoute . '/addNetworkPicture', array('gallery_id' => $this->gallery->id)),
