...
<?php echo CHtml::openTag('div', $this->htmlOptions); ?>
    ...
    <div class="btn-toolbar gform">
        ...
        <span class="btn btn-success add-network-picture-button">
            <i class="icon-plus icon-white"></i>
            <?php echo Yii::t('galleryManager.main', 'AddRemote');?>
        </span>        
...
<!--        <div class="btn-group">
    ...
    <!-- Modal window to add photo from network -->
    <div class="modal hide add-network-picture-modal">
        <div class="modal-header">
            <a class="close" data-dismiss="modal">×</a>

            <h3><?php echo Yii::t('galleryManager.main', 'AddRemote')?></h3>
        </div>
        <div class="modal-body">
            <div class="network-picture-form"></div>
        </div>
        <div class="modal-footer">
            <a href="#" class="btn btn-primary save-network-picture-btn">
